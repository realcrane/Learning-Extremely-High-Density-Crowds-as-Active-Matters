...
def train(model, optimizer, scheduler, train_loader, cfg, epoch):
    ...
    infos = 'Train {} epoch {}/{}'.format('Alpha for MPM', epoch, cfg.epochs)
...
if __name__ == '__main__':
    ...
    root_folder = f'checkpoints_st{cfg.n_substeps}_E{cfg.E}_K{cfg.K}_alpha'
    ...
    total_params = count_parameters(model.get_super_paras_alpha)
    print(f'Total trainable parameters: {total_params}')

    pretrained_path = 'checkpoints_st30_E200_K1/exp1_lr0.0001_lambda0.9_r3/mpm_best.pth'
    if os.path.exists(pretrained_path):
        log_file.log('log the pretrained model : {}'.format(pretrained_path))
