...
def train(model, optimizer, scheduler, train_loader, cfg, epoch):
    ...
    infos = 'Train {} epoch {}/{}'.format('MPM only K', epoch, cfg.epochs)
...
if __name__ == '__main__':
    ...
    root_folder = f'checkpoints_E{cfg.E}_w_ext{cfg.w_ext}_K{cfg.K}'
    ...
    optimizer = torch.optim.Adam(model.get_super_paras_K.parameters(), lr=cfg.lr)
