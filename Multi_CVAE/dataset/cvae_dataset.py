...
class CVAEDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        cond_3[:, 1:29, 1:19, 0] = (grid_v_in[:, 2:30, 1:19, 0] + grid_v_in[:, 0:28, 1:19, 0] - grid_v_in[:, 1:29, 1:19, 0]) / self.cfg.dx ** 2
        cond_3[:, 1:29, 1:19, 1] = (grid_v_in[:, 1:29, 2:20, 1] + grid_v_in[:, 1:29, 0:18, 1] - grid_v_in[:, 1:29, 1:19, 1]) / self.cfg.dx ** 2
