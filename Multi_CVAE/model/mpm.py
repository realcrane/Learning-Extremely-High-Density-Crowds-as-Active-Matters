...
from model.Resnet2 import CVAE
...
class MPM(nn.Module):
    def __init__(self, cfg):
        ...
        self.get_active_force2 = CVAE(z_dim=256, n_decoder=cfg.n_decoder)
    ...
    def P2G(self, ):
        ...
        output = self.get_active_force2.sample(input).squeeze(0).permute(1, 2, 0)
        w_active_force_2 = output.view(-1, 2) * self.grid_mass.unsqueeze(1)
